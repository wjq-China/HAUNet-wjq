...
def create_dataloaders(args):
    ...
    if args.dataset == 'AID':
        ...
        training_set = UCMercedDataset(args, root_dir='/root/autodl-tmp/datasets/UCMerced-dataset-haunet/train',
                                 train=True)
        val_set = UCMercedDataset(args, root_dir='/root/autodl-tmp/datasets/UCMerced-dataset-haunet/val',
                            train=False)
        test_set = UCMercedDataset(args, root_dir='/root/autodl-tmp/datasets/UCMerced-dataset-haunet/val',
                                  train=False)
    # elif args.dataset == 'UCMerced':
    #     from data.ucmerced import UCMercedDataset
    ...
    #                               train=False)
        ...
        training_set = RSCNN7Dataset(args, root_dir='/home/wjq/wjqHD/RSISR/datasets/HAUNet/RSSCN7/train',
                                       train=True)
        val_set = RSCNN7Dataset(args, root_dir='/home/wjq/wjqHD/RSISR/datasets/HAUNet/RSSCN7/val',
                                  train=False)
        test_set = RSCNN7Dataset(args, root_dir='/home/wjq/wjqHD/RSISR/datasets/HAUNet/RSSCN7/val',
                                   train=False)
    ...
    dataloaders = {'train': DataLoader(training_set, batch_size=args.batch_size,
                                 shuffle=True, num_workers=args.n_threads, pin_memory=True),  # args.n_threads
